	...
	<view>
		...
		<view class="loginBox">
			...
			<view class="loginInptu">
				<input type="number" class="username" value="" placeholder="请输入手机号" maxlength="11" @input="phoneInput"/>
			</view>
			...
			<button class="cu-btn block bg-orange margin-tb-sm lg loginButton"> 注册</button>
		...
		<view class="bottomBox">
			...
			<view class="yonghuzhuce" @click="login">已有账号</view>
		</view>
	</view>
</template>
