<template>
	<view>
		<view v-if="leftBottom||rightBottom||leftTop||rightTop||rightCenter" :class="{
        'uni-fab--leftBottom': leftBottom,
        'uni-fab--rightBottom': rightBottom,
        'uni-fab--leftTop': leftTop,
        'uni-fab--rightTop': rightTop,
		'uni-fab-rightCenter': rightCenter
      }" class="uni-fab">
			<view :class="{
		...
		<view :class="{
		  ...
		  'uni-fab__circle--rightCenter': rightCenter,
		  'uni-fab__content--other-platform': !isAndroidNvue
		}" class="uni-fab__circle uni-fab__plus" style="background: url('/static/service.png') no-repeat center" @click="_onClick">
		</view>
	</view>
</template>
...
<script>
	...
	export default {
		...
		computed: {
			...
			rightCenter() {
				return this.getPosition(0, 'right', 'center')
			},
			flexDirectionStart() {
...
<style scoped>
	...
	.uni-fab__circle--rightCenter {
		right: 15px;
		top: 140px;
		/* #ifdef H5 */
		top: calc(140px + var(--window-top));
		/* #endif */
	}
